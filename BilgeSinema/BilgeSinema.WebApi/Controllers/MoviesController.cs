...
using BilgeSinema.WebApi.Models;
using Microsoft.AspNetCore.Mvc;

namespace BilgeSinema.WebApi.Controllers
{
    ...
    public class MoviesController : Controller
    {
        ...
        {
            var getMovieDtos = _movieService.GetMovie();
        ...
        {
           var result = _movieService.DiscountMovie(id);
